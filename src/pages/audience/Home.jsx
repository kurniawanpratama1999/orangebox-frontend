...
const Hero = () => {
  return (
    <section id="hero" className="h-[80dvh] relative">
      <img
        src="/images/hero.jpg"
        alt="hero"
...
const Facilities = () => {
  return (
    <section id="location" className="px-2 text-orange-800 bg-black/5 py-5">
      ...
      <div className="grid grid-cols-3 gap-x-3 gap-y-5">
        {[
          ...
          <div key={i} className="w-full text-center">
            <div className="w-full aspect-square bg-orange-300 text-xs font-bold"></div>
            <p>{v}</p>
          </div>
        ))}
      </div>
    ...
    <section className="py-5">
      ...
      <div className="space-y-5">
        <div className="">
          ...
          <div className="w-full bg-black/10 h-32 flex overflow-x-auto gap-x-3">
            {[1, 2, 3, 4, 5].map((v, i) => {
              return (
                <div
                  key={"coffee-" + i}
                  className="h-full min-w-4/5 border bg-orange-300 flex-center">
...
const PlaceCollection = () => {
  return (
    <section className="py-5 bg-black/5">
      <h6 className="px-3 text-lg font-semibold text-orange-800 mb-1">
        Our Place
      </h6>
      <div className="grid gap-4">
        <div className="relative w-full h-32 bg-orange-300 row-start-1 col-span-2">
        ...
        <div className="relative w-full h-32 bg-orange-300 row-start-2 col-start-1">
          <span className="absolute font-semibold bottom-0 left-0 right-0 italic bg-black/5 px-2 py-1 text-sm text-white text-shadow-[.5px_.5px_0px_black]">
            LIVE MUSIC
          </span>
        </div>
        <div className="relative w-full h-32 bg-orange-300 row-start-2 col-start-2">
          <span className="absolute font-semibold bottom-0 left-0 right-0 italic bg-black/5 px-2 py-1 text-sm text-white text-shadow-[.5px_.5px_0px_black]">
            LONG TABLE
          </span>
        </div>
        <div className="relative w-full h-32 bg-orange-300 row-start-3 col-span-2">
          <span className="absolute font-semibold bottom-0 left-0 right-0 italic bg-black/5 px-2 py-1 text-sm text-white text-shadow-[.5px_.5px_0px_black]">
            CLEAN KITCHEN
          </span>
        </div>
...
const Footer = () => {
  return (
    <footer>
      <div className="w-full h-32 bg-orange-300"></div>

      <div className="text-sm px-3 text-orange-800 space-y-3 text-center py-3">
        <div>
      ...
      <div className="flex item-center justify-center gap-x-2 flex-wrap text-xs px-3 text-orange-800 bg-black/10 py-2">
        <a href="#">Home</a>
        <span>|</span>
        <a href="#">Fasilitas</a>
        <span>|</span>
